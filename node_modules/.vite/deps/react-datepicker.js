...
var Composite = React2.forwardRef(function Composite2(props, forwardedRef) {
  ...
  const computedProps = {
    ...
    onKeyDown(e3) {
      domProps.onKeyDown == null || domProps.onKeyDown(e3);
...
var CompositeItem = React2.forwardRef(function CompositeItem2(props, forwardedRef) {
  ...
  const computedProps = {
    ...
    onFocus(e3) {
      domProps.onFocus == null || domProps.onFocus(e3);
...
function Ne(e3) {
  return function(e4) {
    if (Array.isArray(e4)) return xe(e4);
  }(e3) || function(e4) {
    if ("undefined" != typeof Symbol && null != e4[Symbol.iterator] || null != e4["@@iterator"]) return Array.from(e4);
  }(e3) || function(e4, t3) {
    if (!e4) return;
    if ("string" == typeof e4) return xe(e4, t3);
    ...
    if ("Arguments" === r2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r2)) return xe(e4, t3);
  }(e3) || function() {
...
function Ae(e3, t3, r2) {
  if ("en" === r2) return format(e3, t3, { useAdditionalWeekYearTokens: true, useAdditionalDayOfYearTokens: true });
  var n = tt(r2);
...
function Pt(e3) {
  if (!isDate(e3)) throw new Error("Invalid date");
  var t3 = new Date(e3);
  return t3.setHours(0, 0, 0, 0), t3;
}
function Nt(e3, t3) {
  if (!isDate(e3) || !isDate(t3)) throw new Error("Invalid date received");
...
var Tt = function(t3) {
  function r2() {
    var t4;
    ke(this, r2);
    for (var n = arguments.length, o = new Array(n), a3 = 0; a3 < n; a3++) o[a3] = arguments[a3];
    return Se(Pe(t4 = me(this, r2, [].concat(o))), "state", { dropdownVisible: false }), Se(Pe(t4), "renderSelectOptions", function() {
      for (var r3 = t4.props.minDate ? getYear(t4.props.minDate) : 1900, n2 = t4.props.maxDate ? getYear(t4.props.maxDate) : 2100, o2 = [], a4 = r3; a4 <= n2; a4++) o2.push(import_react4.default.createElement("option", { key: a4, value: a4 }, a4));
      return o2;
...
function Rt(e3, t3) {
  for (var r2 = [], n = Qe(e3), o = Qe(t3); !isAfter(n, o); ) r2.push(Le(n)), n = addMonths(n, 1);
  return r2;
}
...
var Wt = function(t3) {
  function n() {
    var t4;
    ke(this, n);
    for (var r2 = arguments.length, o = new Array(r2), a3 = 0; a3 < r2; a3++) o[a3] = arguments[a3];
...
var zt = function(t3) {
  function n(t4) {
    ...
    return ke(this, n), Se(Pe(o = me(this, n, [t4])), "YEAR_REFS", Ne(Array(o.props.yearItemNumber)).map(function() {
      ...
      if (!o.isInSelectingRange(e3)) return false;
      ...
      var r2 = e3.key;
      if (!o.props.disabledKeyboardNavigation) switch (r2) {
        case "Enter":
...
var Xt = function(t3) {
  function n(t4) {
    ...
    return ke(this, n), Se(Pe(o = me(this, n, [t4])), "handleClickOutside", function(e3) {
      ...
      if (o.props.showYearDropdown && !t5) return import_react4.default.createElement(Tt, { adjustDateOnChange: o.props.adjustDateOnChange, date: o.state.date, onSelect: o.props.onSelect, setOpen: o.props.setOpen, dropdownMode: o.props.dropdownMode, onChange: o.changeYear, minDate: o.props.minDate, maxDate: o.props.maxDate, year: getYear(o.state.date), scrollableYearDropdown: o.props.scrollableYearDropdown, yearDropdownItemNumber: o.props.yearDropdownItemNumber });
    }), Se(Pe(o), "renderMonthDropdown", function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (o.props.showMonthDropdown && !t5) return import_react4.default.createElement(Ot, { dropdownMode: o.props.dropdownMode, locale: o.props.locale, onChange: o.changeMonth, month: getMonth(o.state.date), useShortMonthInDropdown: o.props.useShortMonthInDropdown });
    }), Se(Pe(o), "renderMonthYearDropdown", function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (o.props.showMonthYearDropdown && !t5) return import_react4.default.createElement(Ft, { dropdownMode: o.props.dropdownMode, locale: o.props.locale, dateFormat: o.props.dateFormat, onChange: o.changeMonthYear, minDate: o.props.minDate, maxDate: o.props.maxDate, date: o.state.date, scrollableMonthYearDropdown: o.props.scrollableMonthYearDropdown });
      ...
      if (o.props.todayButton && !o.props.showTimeSelectOnly) return import_react4.default.createElement("div", { className: "react-datepicker__today-button", onClick: function(e3) {
      ...
      if (o.props.showTimeSelect && !o.state.monthContainer || o.props.showTimeSelectOnly) return null;
      ...
      if (o.props.showTimeInput) return import_react4.default.createElement($t, { date: t5, timeString: r2, timeInputLabel: o.props.timeInputLabel, onChange: o.props.onTimeChange, customTimeInput: o.props.customTimeInput });
      ...
      if (o.props.children) return import_react4.default.createElement("div", { className: "react-datepicker__children-container" }, o.props.children);
  ...
  return _e(n, import_react4.default.Component), be(n, [{ key: "componentDidMount", value: function() {
    ...
    var t4 = this;
    if (!this.props.preSelection || $e(this.props.preSelection, e3.preSelection) && this.props.monthSelectedIn === e3.monthSelectedIn) this.props.openToDate && !$e(this.props.openToDate, e3.openToDate) && this.setState({ date: this.props.openToDate });
    else {
...
var ar = (nr = function(t3) {
  ...
  var r2 = import_react4.default.useRef(), n = useFloating2(ve({ open: !t3.hidePopper, whileElementsMounted: autoUpdate, placement: t3.popperPlacement, middleware: [flip3({ padding: 15 }), offset3(10), arrow3({ element: r2 })].concat(Ne(t3.popperModifiers)) }, t3.popperProps));
  ...
  function a3(t4) {
    ...
    return ke(this, a3), Se(Pe(s3 = me(this, a3, [t4])), "getPreSelection", function() {
      ...
      if (e3) {
        ...
        var o = startOfDay(e3);
        if (t5 && r2) n = Je(e3, s3.props.minDate, s3.props.maxDate);
        else if (t5) {
      ...
      if ("Enter" === t5) e3.preventDefault(), s3.handleSelect(n, e3), !s3.props.shouldCloseOnSelect && s3.setPreSelection(n);
      else if ("Escape" === t5) e3.preventDefault(), s3.setOpen(false), s3.inputOk() || s3.props.onInputError({ code: 1, msg: pr });
        ...
        if (!o) return void (s3.props.onInputError && s3.props.onInputError({ code: 1, msg: pr }));
